...
- (void)viewDidLoad {
    ...
    _hospitalArray = @[@{@"name":@"Cebu Doctor's Univercity Hospital",@"address":@"Osmeña Boulevard, Cebu City, 6000 Cebu",@"phoneNumber":@"(032) 255 5555,032-516-3341（日本語直通）",@"cost":@"1500ペソ〜",@"time":@"午前9時～午後6時（月～金）,午前9時～12時（土）,24時間救急外来",@"langage":@"日本語可",@"image":@"cebudoc.jpg",@"lati":@"10.314564",@"longi":@"123.891777"},
                     ...
                     @{@"name":@"Doctor Dental Clinic",@"address":@"Miller Hospital 400 Tres de Abril St. Cebu City",@"phoneNumber":@"(032) 238-8012 or (032)261-6082、rodivickdocor@yahoo.com（日本語可）",@"cost":@"VisaとMaster,1000ペソ〜3000ペソ程度",@"time":@"日～金8:30～17:00（17:00～21:00は要予約）",@"langage":@"日本語可",@"image":@"cebudental.jpg",@"lati":@"10.296605",@"longi":@"123.88854"},
