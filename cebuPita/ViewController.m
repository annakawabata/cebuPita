...
- (void)viewDidLoad {
    ...
    _hospitalArray = @[@{@"name":@"Cebu Doctor's Univercity Hospital",@"address":@"Osmeña Boulevard, Cebu City, 6000 Cebu",@"phoneNumber":@"(032) 255 5555,032-516-3341（日本語直通）",@"cost":@"1500ペソ〜",@"time":@"午前9時～午後6時（月～金）,午前9時～12時（土）,24時間救急外来",@"langage":@"日本語可",@"image":@"cebudoc.jpg"},
                     ...
                     @{@"name":@"Sacred Heart Hospital Urgello Cebu City",@"address":@"J Urgello St. Cebu City、J. Urgello St、Cebu City",@"phoneNumber":@"(032) 418 8410",@"cost":@"詳細なし",@"time":@"詳細なし",@"langage":@"英語",@"image":@"sakured.jpg"},
                     ...
                     @{@"name":@"CEBU NORTH GENERAL HOSPITAL",@"address":@"KAUSWAGAN ROAD, TALAMBAN CITY, CEBU",@"phoneNumber":@"032-343-7777",@"cost":@"セブドクターズ系列総合病院。　CT-SCANあり。MRIなし。　CMSはER受診と入院で利用できます。",@"time":@"24時間（緊急外来）",@"langage":@"英語",@"image":@"north.jpg"}
                     ];
